...
public class randomSpawn : MonoBehaviour {
    ...
    public void Instanciate()
    {
        ...
        if (scen.name != "Menü" && scen.name != "Ende" && scen.name != "ship_switch" && scen.name != "Hilfemenü" && scen.name != "HighScore" && scen.name != "IntroScene") //nur ausführen, wenn der Code nicht im Menü ist, da er nicht gebraucht wird - sonst Fehlermeldungen
        {
